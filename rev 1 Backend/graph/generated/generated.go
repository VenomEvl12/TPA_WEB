...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		DeleteVideo                        func(childComplexity int, playlistID string, videoID *int) int
		...
		UpdateDislike                      func(childComplexity int, videoID string, dislike *int) int
		UpdateLike                         func(childComplexity int, videoID string, like *int) int
		...
		UpdatePriorityWeight               func(childComplexity int, playlistID string, priorityWeight *int) int
		UpdateReplyDescription             func(childComplexity int, replyID string, description *string) int
		UpdateReplyDislikes                func(childComplexity int, replyID string, dislikes *int) int
		UpdateReplyLikes                   func(childComplexity int, replyID string, likes *int) int
		UpdateReplyRepliesDislikes         func(childComplexity int, replyRepliesID string, dislike int) int
		UpdateReplyRepliesLikes            func(childComplexity int, replyRepliesID string, like int) int
		UpdateRestriction                  func(childComplexity int, videoID string, restriction *bool) int
		UpdateSubscribers                  func(childComplexity int, id string, subscribers *int) int
		UpdateVideReplyRepliesLikeVali     func(childComplexity int, videoReplyRepliesLikeValiID string, like *bool) int
		UpdateVideoDislikeVali             func(childComplexity int, videoID string, userID string, dislike *bool) int
		UpdateVideoLikeVali                func(childComplexity int, videoID string, userID string, like *bool) int
		UpdateVideoReplyDislikeVali        func(childComplexity int, userID string, videoID string, replyID string, dislike *bool) int
		UpdateVideoReplyLikeVali           func(childComplexity int, userID string, videoID string, replyID string, like *bool) int
		UpdateVideoReplyRepliesDislikeVali func(childComplexity int, videoReplyRepliesLikeValiID string, dislike *bool) int
		UpdateViews                        func(childComplexity int, videoID string, views *int) int
	}
	...
	Query struct {
		...
		ListReplyReply            func(childComplexity int) int
...
type MutationResolver interface {
	CreateChannel(ctx context.Context, input *model.NewChannel) (*bool, error)
	UpdateChannelView(ctx context.Context, channelID string, viewCount *int) (*bool, error)
	UpdateChannelLocation(ctx context.Context, channelID string, location *string) (*bool, error)
	UpdateChannelDescription(ctx context.Context, channelID string, description *string) (*bool, error)
	UpdateChannelImage(ctx context.Context, channelID string, channelImage *string) (*bool, error)
	CreateChannelCommunities(ctx context.Context, input *model.NewChannelCommunity) (*model.ChannelCommunity, error)
	CreatePlaylist(ctx context.Context, input *model.NewPlaylist) (*bool, error)
	UpdatePriorityWeight(ctx context.Context, playlistID string, priorityWeight *int) (*bool, error)
	DeleteVideo(ctx context.Context, playlistID string, videoID *int) (*bool, error)
	...
	UpdateReplyRepliesLikes(ctx context.Context, replyRepliesID string, like int) (*bool, error)
	UpdateReplyRepliesDislikes(ctx context.Context, replyRepliesID string, dislike int) (*bool, error)
	DeleteReplyReplies(ctx context.Context, replyRepliesID string) (*bool, error)
	CreateUser(ctx context.Context, input *model.NewUser) (*model.User, error)
	UpdatePremium(ctx context.Context, id string, premium *bool) (*bool, error)
	UpdatePremiumCountDay(ctx context.Context, id string, premiumDayCount *int) (*bool, error)
	UpdateLocation(ctx context.Context, id string, location *string) (*bool, error)
	UpdateSubscribers(ctx context.Context, id string, subscribers *int) (*bool, error)
	DeleteComputer(ctx context.Context, id string) (*bool, error)
	CreateUserSubscribe(ctx context.Context, input *model.NewUserSubscribe) (*bool, error)
	...
	UpdateViews(ctx context.Context, videoID string, views *int) (*bool, error)
	UpdateLike(ctx context.Context, videoID string, like *int) (*bool, error)
	UpdateDislike(ctx context.Context, videoID string, dislike *int) (*bool, error)
	UpdateDescription(ctx context.Context, videoID string, descriptions *string) (*bool, error)
	UpdateRestriction(ctx context.Context, videoID string, restriction *bool) (*bool, error)
	UpdatePremiumVideo(ctx context.Context, videoID string, premium *bool) (*bool, error)
	RemoveVideo(ctx context.Context, videoID string) (*bool, error)
	CreateVideoLikeVali(ctx context.Context, input *model.NewVideoLikeVali) (*bool, error)
	UpdateVideoLikeVali(ctx context.Context, videoID string, userID string, like *bool) (*bool, error)
	UpdateVideoDislikeVali(ctx context.Context, videoID string, userID string, dislike *bool) (*bool, error)
	CreateVideoReply(ctx context.Context, input *model.NewVideoReply) (*model.VideoReply, error)
	UpdateReplyLikes(ctx context.Context, replyID string, likes *int) (*bool, error)
	UpdateReplyDislikes(ctx context.Context, replyID string, dislikes *int) (*bool, error)
	UpdateReplyDescription(ctx context.Context, replyID string, description *string) (*bool, error)
	DeleteReply(ctx context.Context, replyID string) (*bool, error)
	CreateNewVideoReplyLikeVali(ctx context.Context, input model.NewVideoReplyLikeVali) (*bool, error)
	UpdateVideoReplyLikeVali(ctx context.Context, userID string, videoID string, replyID string, like *bool) (*bool, error)
	UpdateVideoReplyDislikeVali(ctx context.Context, userID string, videoID string, replyID string, dislike *bool) (*bool, error)
	DeleteVideoReplyLikeVali(ctx context.Context, videoID string, replyID string) (*bool, error)
	CreateNewVideoReplyRepliesLikeVali(ctx context.Context, input *model.NewVideoReplyRepliesLikeVali) (*bool, error)
	UpdateVideReplyRepliesLikeVali(ctx context.Context, videoReplyRepliesLikeValiID string, like *bool) (*bool, error)
	UpdateVideoReplyRepliesDislikeVali(ctx context.Context, videoReplyRepliesLikeValiID string, dislike *bool) (*bool, error)
...
type QueryResolver interface {
	...
	Playlist(ctx context.Context) ([]*model.Playlist, error)
	...
	ListReplyReply(ctx context.Context) ([]*model.ReplyReplies, error)
	Users(ctx context.Context, email string) (*model.User, error)
	UserSubscribes(ctx context.Context) ([]*model.UserSubscribe, error)
	...
	VideoReplies(ctx context.Context) ([]*model.VideoReply, error)
	VideoReply(ctx context.Context, userID string, videoID string) (*model.VideoReply, error)
	VideoReplyLikeVali(ctx context.Context) (*model.VideoReplyLikeVali, error)
	VideoReplyRepliesLikeVali(ctx context.Context, videoReplyRepliesLikeValiID string) (*model.VideoReplyLikeVali, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "ChannelCommunity.userID":
		if e.complexity.ChannelCommunity.UserID == nil {
			break
		}

		return e.complexity.ChannelCommunity.UserID(childComplexity), true
	...
	case "Mutation.deletePlaylist":
		...
		return e.complexity.Mutation.DeletePlaylist(childComplexity, args["playListID"].(string)), true
	...
	case "Mutation.deleteVideo":
		...
		return e.complexity.Mutation.DeleteVideo(childComplexity, args["playlistID"].(string), args["videoID"].(*int)), true
	...
	case "Mutation.updateDislike":
		...
		return e.complexity.Mutation.UpdateDislike(childComplexity, args["VideoID"].(string), args["dislike"].(*int)), true
	...
	case "Mutation.updateLike":
		...
		return e.complexity.Mutation.UpdateLike(childComplexity, args["VideoID"].(string), args["like"].(*int)), true
	...
	case "Mutation.updatePriorityWeight":
		...
		return e.complexity.Mutation.UpdatePriorityWeight(childComplexity, args["playlistID"].(string), args["priorityWeight"].(*int)), true
	...
	case "Mutation.updateReplyDislikes":
		...
		return e.complexity.Mutation.UpdateReplyDislikes(childComplexity, args["replyID"].(string), args["dislikes"].(*int)), true
	...
	case "Mutation.updateReplyLikes":
		...
		return e.complexity.Mutation.UpdateReplyLikes(childComplexity, args["replyID"].(string), args["likes"].(*int)), true
	...
	case "Mutation.updateReplyRepliesDislikes":
		...
		return e.complexity.Mutation.UpdateReplyRepliesDislikes(childComplexity, args["replyRepliesID"].(string), args["dislike"].(int)), true
	...
	case "Mutation.updateReplyRepliesLikes":
		...
		return e.complexity.Mutation.UpdateReplyRepliesLikes(childComplexity, args["replyRepliesID"].(string), args["like"].(int)), true
	...
	case "Mutation.updateSubscribers":
		...
		return e.complexity.Mutation.UpdateSubscribers(childComplexity, args["id"].(string), args["subscribers"].(*int)), true
	...
	case "Mutation.updateVideReplyRepliesLikeVali":
		...
		return e.complexity.Mutation.UpdateVideReplyRepliesLikeVali(childComplexity, args["videoReplyRepliesLikeValiID"].(string), args["like"].(*bool)), true
	...
	case "Mutation.updateVideoDislikeVali":
		...
		return e.complexity.Mutation.UpdateVideoDislikeVali(childComplexity, args["videoID"].(string), args["userID"].(string), args["dislike"].(*bool)), true
	...
	case "Mutation.updateVideoLikeVali":
		...
		return e.complexity.Mutation.UpdateVideoLikeVali(childComplexity, args["videoID"].(string), args["userID"].(string), args["like"].(*bool)), true
	...
	case "Mutation.updateVideoReplyDislikeVali":
		...
		return e.complexity.Mutation.UpdateVideoReplyDislikeVali(childComplexity, args["userID"].(string), args["videoID"].(string), args["replyID"].(string), args["dislike"].(*bool)), true
	...
	case "Mutation.updateVideoReplyLikeVali":
		...
		return e.complexity.Mutation.UpdateVideoReplyLikeVali(childComplexity, args["userID"].(string), args["videoID"].(string), args["replyID"].(string), args["like"].(*bool)), true
	...
	case "Mutation.updateVideoReplyRepliesDislikeVali":
		...
		return e.complexity.Mutation.UpdateVideoReplyRepliesDislikeVali(childComplexity, args["VideoReplyRepliesLikeValiID"].(string), args["dislike"].(*bool)), true
	...
	case "Mutation.updateViews":
		...
		return e.complexity.Mutation.UpdateViews(childComplexity, args["VideoID"].(string), args["views"].(*int)), true
	...
	case "Query.listReplyReply":
		...
		return e.complexity.Query.ListReplyReply(childComplexity), true
	...
	case "Query.playlist":
		...
		return e.complexity.Query.Playlist(childComplexity), true
	...
	case "Query.userSubscribes":
		...
		return e.complexity.Query.UserSubscribes(childComplexity), true
	...
	case "Query.videoReplies":
		...
		return e.complexity.Query.VideoReplies(childComplexity), true
	...
	case "Query.videoReplyLikeVali":
		...
		return e.complexity.Query.VideoReplyLikeVali(childComplexity), true
	...
	case "ReplyReplies.userID":
		if e.complexity.ReplyReplies.UserID == nil {
			break
		}

		return e.complexity.ReplyReplies.UserID(childComplexity), true
	...
	case "VideoReply.userID":
		if e.complexity.VideoReply.UserID == nil {
			break
		}

		return e.complexity.VideoReply.UserID(childComplexity), true
...
func (ec *executionContext) field_Mutation_createChannelCommunities_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalOnewChannelCommunity2ᚖTPABackEndᚋgraphᚋmodelᚐNewChannelCommunity(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_createPlaylist_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalOnewPlaylist2ᚖTPABackEndᚋgraphᚋmodelᚐNewPlaylist(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_createVideoReply_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalOnewVideoReply2ᚖTPABackEndᚋgraphᚋmodelᚐNewVideoReply(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateSubscribers_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	args["id"] = arg0
	var arg1 *int
	if tmp, ok := rawArgs["subscribers"]; ok {
		arg1, err = ec.unmarshalOInt2ᚖint(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
	args["subscribers"] = arg1
	return args, nil
}
...
func (ec *executionContext) _ChannelCommunity_userID(ctx context.Context, field graphql.CollectedField, obj *model.ChannelCommunity) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_updatePriorityWeight(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdatePriorityWeight(rctx, args["playlistID"].(string), args["priorityWeight"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_deleteVideo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteVideo(rctx, args["playlistID"].(string), args["videoID"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_deletePlaylist(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeletePlaylist(rctx, args["playListID"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_createReplyReplies(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOReplyReplies2ᚖTPABackEndᚋgraphᚋmodelᚐReplyReplies(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateReplyRepliesLikes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateReplyRepliesLikes(rctx, args["replyRepliesID"].(string), args["like"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateReplyRepliesDislikes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateReplyRepliesDislikes(rctx, args["replyRepliesID"].(string), args["dislike"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateSubscribers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateSubscribers(rctx, args["id"].(string), args["subscribers"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateViews(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateViews(rctx, args["VideoID"].(string), args["views"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateLike(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateLike(rctx, args["VideoID"].(string), args["like"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateDislike(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateDislike(rctx, args["VideoID"].(string), args["dislike"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateVideoLikeVali(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateVideoLikeVali(rctx, args["videoID"].(string), args["userID"].(string), args["like"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateVideoDislikeVali(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateVideoDislikeVali(rctx, args["videoID"].(string), args["userID"].(string), args["dislike"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_createVideoReply(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOVideoReply2ᚖTPABackEndᚋgraphᚋmodelᚐVideoReply(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateReplyLikes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateReplyLikes(rctx, args["replyID"].(string), args["likes"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateReplyDislikes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateReplyDislikes(rctx, args["replyID"].(string), args["dislikes"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateVideoReplyLikeVali(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateVideoReplyLikeVali(rctx, args["userID"].(string), args["videoID"].(string), args["replyID"].(string), args["like"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateVideoReplyDislikeVali(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateVideoReplyDislikeVali(rctx, args["userID"].(string), args["videoID"].(string), args["replyID"].(string), args["dislike"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateVideReplyRepliesLikeVali(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateVideReplyRepliesLikeVali(rctx, args["videoReplyRepliesLikeValiID"].(string), args["like"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateVideoReplyRepliesDislikeVali(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateVideoReplyRepliesDislikeVali(rctx, args["VideoReplyRepliesLikeValiID"].(string), args["dislike"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_getChannel(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOChannel2ᚖTPABackEndᚋgraphᚋmodelᚐChannel(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_playlist(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Playlist(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOPlaylist2ᚕᚖTPABackEndᚋgraphᚋmodelᚐPlaylist(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_priorityNumber(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Playlist)
	fc.Result = res
	return ec.marshalOPlaylist2ᚖTPABackEndᚋgraphᚋmodelᚐPlaylist(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_listReplyReply(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().ListReplyReply(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_userSubscribes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().UserSubscribes(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_videoReplies(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().VideoReplies(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_videoReplyLikeVali(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().VideoReplyLikeVali(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _ReplyReplies_userID(ctx context.Context, field graphql.CollectedField, obj *model.ReplyReplies) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _VideoReply_userID(ctx context.Context, field graphql.CollectedField, obj *model.VideoReply) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) unmarshalInputnewChannel(ctx context.Context, obj interface{}) (model.NewChannel, error) {
	...
	for k, v := range asMap {
		...
		case "channelDescription":
			var err error
			it.ChannelDescription, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "channelImage":
			var err error
			it.ChannelImage, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputnewPlaylist(ctx context.Context, obj interface{}) (model.NewPlaylist, error) {
	...
	for k, v := range asMap {
		...
		case "priorityWeight":
			var err error
			it.PriorityWeight, err = ec.unmarshalOInt2ᚖint(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputnewVideoReplyRepliesLikeVali(ctx context.Context, obj interface{}) (model.NewVideoReplyRepliesLikeVali, error) {
	...
	for k, v := range asMap {
		...
		case "videoReplyRepliesLikeValiID":
			var err error
			it.VideoReplyRepliesLikeValiID, err = ec.unmarshalNID2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "userID":
...
func (ec *executionContext) _ChannelCommunity(ctx context.Context, sel ast.SelectionSet, obj *model.ChannelCommunity) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "userID":
			out.Values[i] = ec._ChannelCommunity_userID(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "comDescription":
...
func (ec *executionContext) _ReplyReplies(ctx context.Context, sel ast.SelectionSet, obj *model.ReplyReplies) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "userID":
			out.Values[i] = ec._ReplyReplies_userID(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "like":
...
func (ec *executionContext) _VideoReply(ctx context.Context, sel ast.SelectionSet, obj *model.VideoReply) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "userID":
			out.Values[i] = ec._VideoReply_userID(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "videoID":
...
func (ec *executionContext) marshalOChannel2TPABackEndᚋgraphᚋmodelᚐChannel(ctx context.Context, sel ast.SelectionSet, v model.Channel) graphql.Marshaler {
	return ec._Channel(ctx, sel, &v)
}

func (ec *executionContext) marshalOChannel2ᚖTPABackEndᚋgraphᚋmodelᚐChannel(ctx context.Context, sel ast.SelectionSet, v *model.Channel) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Channel(ctx, sel, v)
...
func (ec *executionContext) marshalOPlaylist2TPABackEndᚋgraphᚋmodelᚐPlaylist(ctx context.Context, sel ast.SelectionSet, v model.Playlist) graphql.Marshaler {
	return ec._Playlist(ctx, sel, &v)
}

func (ec *executionContext) marshalOPlaylist2ᚕᚖTPABackEndᚋgraphᚋmodelᚐPlaylist(ctx context.Context, sel ast.SelectionSet, v []*model.Playlist) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOPlaylist2ᚖTPABackEndᚋgraphᚋmodelᚐPlaylist(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOPlaylist2ᚖTPABackEndᚋgraphᚋmodelᚐPlaylist(ctx context.Context, sel ast.SelectionSet, v *model.Playlist) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Playlist(ctx, sel, v)
...
func (ec *executionContext) marshalOReplyReplies2TPABackEndᚋgraphᚋmodelᚐReplyReplies(ctx context.Context, sel ast.SelectionSet, v model.ReplyReplies) graphql.Marshaler {
	return ec._ReplyReplies(ctx, sel, &v)
}

func (ec *executionContext) marshalOReplyReplies2ᚖTPABackEndᚋgraphᚋmodelᚐReplyReplies(ctx context.Context, sel ast.SelectionSet, v *model.ReplyReplies) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._ReplyReplies(ctx, sel, v)
...
func (ec *executionContext) marshalOVideoReply2TPABackEndᚋgraphᚋmodelᚐVideoReply(ctx context.Context, sel ast.SelectionSet, v model.VideoReply) graphql.Marshaler {
	return ec._VideoReply(ctx, sel, &v)
}

func (ec *executionContext) marshalOVideoReply2ᚖTPABackEndᚋgraphᚋmodelᚐVideoReply(ctx context.Context, sel ast.SelectionSet, v *model.VideoReply) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._VideoReply(ctx, sel, v)
...
func (ec *executionContext) unmarshalOnewChannelCommunity2TPABackEndᚋgraphᚋmodelᚐNewChannelCommunity(ctx context.Context, v interface{}) (model.NewChannelCommunity, error) {
	return ec.unmarshalInputnewChannelCommunity(ctx, v)
}

func (ec *executionContext) unmarshalOnewChannelCommunity2ᚖTPABackEndᚋgraphᚋmodelᚐNewChannelCommunity(ctx context.Context, v interface{}) (*model.NewChannelCommunity, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalOnewChannelCommunity2TPABackEndᚋgraphᚋmodelᚐNewChannelCommunity(ctx, v)
	return &res, err
}

func (ec *executionContext) unmarshalOnewPlaylist2TPABackEndᚋgraphᚋmodelᚐNewPlaylist(ctx context.Context, v interface{}) (model.NewPlaylist, error) {
	return ec.unmarshalInputnewPlaylist(ctx, v)
}

func (ec *executionContext) unmarshalOnewPlaylist2ᚖTPABackEndᚋgraphᚋmodelᚐNewPlaylist(ctx context.Context, v interface{}) (*model.NewPlaylist, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalOnewPlaylist2TPABackEndᚋgraphᚋmodelᚐNewPlaylist(ctx, v)
	return &res, err
}
...
func (ec *executionContext) unmarshalOnewVideoReply2TPABackEndᚋgraphᚋmodelᚐNewVideoReply(ctx context.Context, v interface{}) (model.NewVideoReply, error) {
	return ec.unmarshalInputnewVideoReply(ctx, v)
}

func (ec *executionContext) unmarshalOnewVideoReply2ᚖTPABackEndᚋgraphᚋmodelᚐNewVideoReply(ctx context.Context, v interface{}) (*model.NewVideoReply, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalOnewVideoReply2TPABackEndᚋgraphᚋmodelᚐNewVideoReply(ctx, v)
	return &res, err
}
